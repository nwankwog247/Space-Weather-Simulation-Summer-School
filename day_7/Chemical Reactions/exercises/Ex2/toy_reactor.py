...
def reaction_rates(c,k):
    ...
    """
    #c = np.array(c_0(A), c_0(B), c_0(C))
    #k = np.array
    #c_dot = 
    return np.array([k[0]*c[0], k[1]*c[1], k[2]*c[2]**2])
...
def reactor(c,t,k,S):
    """
        ...
        outputs: 
            dc/dt - numpy array
    """
    return S @ reaction_rates(c,k) #where @ is a python matrix function???
