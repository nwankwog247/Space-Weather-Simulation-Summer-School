...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 27 12:13:29 2022
...
from helper_functions_O import *
from physics_functions_O import *
...
if __name__ == '__main__':  # main code block
    ...
    #I will have to compute scale height for o2 here
    h_o2 = calc_scale_height(mass_o2, alts, temp)
    print('Scale height of o : ', h_o2)
    
    #I will have to compute scale height for n2 here
    h_n2 = calc_scale_height(mass_n2, alts, temp)
    print('Scale height of o : ', h_n2)
    ...
    print('Density of o : ', density_o)
    
    #I will calculate the density of o2 as a function of alt and temp 
    density_o2 = calc_hydrostatic(n_o2_bc, h_o2, temp, alts)
    print('Density of o2 : ', density_o2)
    
    #I will calculate the density of o2 as a function of alt and temp 
    density_n2 = calc_hydrostatic(n_n2_bc, h_n2, temp, alts)
    print('Density of n2 : ', density_n2)
    ...
    #I will calculate Tau for o2 at all wavelengths
    tau_o2 = calc_tau(SZA, density_o2, h_o2, euv_info['ocross'])
    
    #I will calculate Tau for n2 at all wavelengths
